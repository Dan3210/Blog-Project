...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'pass1234',
        'HOST': 'database-1.crwqcqokqgxp.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blogprojectvpcbucket' # please enter your s3 bucket name
